    ...
    <div class="wrapper">
        ...
        <?php
            if(isset($_GET['id']))
            {
                ...
                {
                    $_SESSION['no-service-found'] = "service not found";
            ...
            <table class="tbl-30">
                ...
                <tr>
                    ...
                    <td>
                        <?php
                            ...
                            {
                                ?>
                                <img src="<?php echo SITEURL;?>services/<?php echo $current_image;?>" width="100px">
                                <?php
                            }
                            else
                            {
                ...
                <tr>
                    <td>
                        ...
                        <input type="submit" name="submit" value="Update Services" class="btn-secondary">
                    </td>
                </tr>
            </table>
        </form>
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name !="")
                    {
                        ...
                        if($upload==false)
                        {
                            ...
                            header('loaction:'.SITEURL.'admin/manage-service.php');
                            die();
                        ...
                        if($current_image != "")
                        {
                            $remove_path ="../services/".$current_image;
