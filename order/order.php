            ...
            <div class="float-container">
                    ...
                    <div class="float-child">
                        ...
                        <fieldset class="fs1">
                            ...
                            {
                                ?>
                                    <img src="http://localhost/project/combos/<?php echo $image_name;?>" class="img">
                                <?php
                            }
                        ...
                        ?>
                            ...
                            <label class="label">price: ₹<?php echo $price;?>/Hour</label><br><br>
                            <input type="hidden" name="price" value="<?php echo $price;?>"><!--hidden-->
